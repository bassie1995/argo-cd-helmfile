...
LABEL org.opencontainers.image.source=https://github.com/bassie1995/argo-cd-helmfile
...
RUN apt-get update && apt-get install --no-install-recommends -y \
    ...
    chmod go+r /etc/apt/trusted.gpg.d/microsoft.gpg && \
